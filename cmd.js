...
function saveHistory(history) {
    const historyFilePath = "history.json";
    try {
        fs.writeFileSync(historyFilePath, JSON.stringify(history, null, 2)); // Menambahkan null, 2 agar hasil penyimpanan lebih terbaca
    } catch (error) {
